...
public class StaffController {
	...
	@PutMapping
	public ResponseEntity<ResponseStructure<StaffDto>> 
	updateStaffById(@RequestParam int staffId, @RequestBody Staff staff) 
	{
		return service.updateStaffById(staffId, staff);
	}
