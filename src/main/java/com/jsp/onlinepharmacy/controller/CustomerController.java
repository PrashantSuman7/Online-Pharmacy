...
public class CustomerController {
	...
	@PostMapping
	public ResponseEntity<ResponseStructure<CustomerDto>> addCustomer
	(@RequestParam int addressId,@RequestBody Customer customer)
	{
		return service.addCustomer(addressId, customer);
	}
	@PutMapping
	public ResponseEntity<ResponseStructure<CustomerDto>>
	updateCustomer(@RequestParam int customerId, @RequestBody Customer customer)
	{
	...
	@PutMapping("/forgot")
	public ResponseEntity<ResponseStructure<CustomerDto>> forgotPassword(@RequestParam String email, @RequestParam long phoneNumber,  @RequestParam String password)
	{
		return service.forgotPassword(email, phoneNumber, password);
	}
